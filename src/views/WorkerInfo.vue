    ...
    methods: {
        ...
        changeItem(ID) {
            if (this.status == 0) {
                ...
                axios({
                        method: "post",
                        url: "http://192.168.50.86:9000/adminuser/update",
                        data: jsonStr
                    }
                ).then((res) => {
        ...
        addItem() {
            ...
            axios({
                    method: "post",
                    url: "http://192.168.50.86:9000/adminuser/adduser",
                    data: jsonStr
                }
            ).then((res) => {
                if (res.data.code == 200) {
        ...
        getList() {
            ...
            axios({
                    method: "post",
                    url: "http://192.168.50.86:9000/adminuser/all",
                    data: jsonStr
                }
            ).then((res) => {
                const item = res.data;
        ...
        deleteUser(user) {
            ...
            axios({
                    method: "post",
                    url: "http://192.168.50.86:9000/adminuser/del",
                    data: jsonStr
                }
            ).then((res) => {
                if (res.data.code == 200) {
        ...
        search() {
            ...
            axios({
                    method: "post",
                    url: "http://192.168.50.86:9000/adminuser/queryname",
                    data: jsonStr
                }
            ).then((res) => {
                const item = res.data;
